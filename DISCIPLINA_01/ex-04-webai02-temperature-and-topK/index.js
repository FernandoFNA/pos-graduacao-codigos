...
(async function main() {
  document.getElementById("download_btn").addEventListener("click", downloadIA);
  ...
  //inicializando na mao por motivos de preguica de transformar numa google extension
  const params = {
